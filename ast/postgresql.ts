...
export type create_table_stmt = AstStatement<create_table_partition_of>; | AstStatement<create_table_stmt_node> | AstStatement<create_table_stmt_node>;;
...
export type for_values_item = { type: 'for_values_item'; keyword: 'from'; from: literal_string; to: literal_string; } | { type: 'for_values_item'; keyword: 'in'; in: expr_list; } | { type: 'for_values_item'; keyword: 'with'; modulus: literal_numeric; remainder: literal_numeric; };

export type for_values = { type: 'for_values'; keyword: 'for values'; expr: for_values_item; };

export type create_table_partition_of = { type: 'partition_of'; keyword: 'partition of'; table: table_name; for_values:for_values; tablespace:ident_without_kw_type };
...
export type column_definition_opt = column_constraint | { auto_increment: 'auto_increment'; } | { unique: 'unique' | 'unique key'; } | { generated_by: 'generated by default' | 'generated always'; } | { as_identity: 'as identity'; } | { unique: 'key' | 'primary key'; } | { comment: keyword_comment; } | { collate: collate_expr; } | { column_format: column_format; } | { storage: storage } | { reference_definition: reference_definition; } | { character_set: collate_expr };
...
export type column_definition_opt_list = {
        ...
        generated_by?: 'generated by default' | 'generated always' | 'generated by always';
...
export type alter_action = ALTER_ADD_COLUMN | ALTER_ADD_CONSTRAINT | ALTER_DROP_COLUMN | ALTER_ALTER_COLUMN | ALTER_RENAME_COLUMN | ALTER_ADD_INDEX_OR_KEY | ALTER_ADD_FULLETXT_SPARITAL_INDEX | ALTER_RENAME | ALTER_ALGORITHM | ALTER_LOCK;
